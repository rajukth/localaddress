...
if (firstRow) {
    ...
    function displayData(data) {
        ...
        data.forEach(function (item, index) {
            ...
            row += `<td>${sn}</td>` +
            `<td>${item.provinceNameEn}</td>` +
            `<td>${item.provinceNameNp}</td>` + 
            `<td>${item.noOfDistrictEn}</td>` +
            `<td>${item.noOfDistrictNp}</td>` + 
    ...
    function updateProvince(id) {
        ...
        window.location.href=`province/create.html?id=${id}`;
